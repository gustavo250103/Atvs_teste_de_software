"""
Testes de INTEGRACAO: Calculadora + HistoricoRepositorio real.
Cobrem sequencia de operacoes, formato do historico e limpeza.
Relacionados às tarefas 1-5 (exemplos, extras, bug, cobertura, relatorio).
"""
